...
type PandacapDbContext(options: DbContextOptions<PandacapDbContext>) =
    ...
    member this.TwtxtFeeds: DbSet<TwtxtFeed> = this.Set()
    member this.TwtxtFeedItems: DbSet<TwtxtFeedItem> = this.Set()
    member this.TwtxtFavorites: DbSet<TwtxtFavorite> = this.Set()
