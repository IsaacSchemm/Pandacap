...
type PandacapDbContext(options: DbContextOptions<PandacapDbContext>) =
    ...
    member this.ESPNContributorFeeds: DbSet<ESPNContributorFeed> = this.Set()
    member this.ESPNContributorPostFeedItems: DbSet<ESPNContributorPostFeedItem> = this.Set()
    member this.ESPNContributorPostFavorites: DbSet<ESPNContributorPostFavorite> = this.Set()
