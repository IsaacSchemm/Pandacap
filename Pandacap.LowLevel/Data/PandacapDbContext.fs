...
type PandacapDbContext(options: DbContextOptions<PandacapDbContext>) =
    ...
    [<System.Obsolete>] member this.RssFeeds: DbSet<RssFeed> = this.Set()
    [<System.Obsolete>] member this.RssFeedItems: DbSet<RssFeedItem> = this.Set()
    [<System.Obsolete>] member this.RssFavorites: DbSet<RssFavorite> = this.Set()
