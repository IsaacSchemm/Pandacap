...
public partial class MastodonVerifier
{
    ...
    public VerificationResult VerifyRequestSignature(HttpRequest message, IKey remoteActor)
    {
    ...
    internal IEnumerable<MastodonSignatureComponents> ParseMastodonSignatureComponents(HttpRequest message)
    {
    ...
    internal virtual MastodonSignatureComponents ParseSignatureValue(IEnumerable<string> parts)
    {
    ...
    internal virtual bool VerifySignature(MastodonSignatureComponents components, IKey remoteActor,
